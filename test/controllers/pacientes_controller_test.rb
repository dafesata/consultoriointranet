...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { eps_id: @paciente.eps_id, numero_id: @paciente.numero_id, tipo_usuario: @paciente.tipo_usuario } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { eps_id: @paciente.eps_id, numero_id: @paciente.numero_id, tipo_usuario: @paciente.tipo_usuario } }
