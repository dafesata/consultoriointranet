...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post servicios_url, params: { servicio: { enable: @servicio.enable, nombre: @servicio.nombre } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { enable: @servicio.enable, nombre: @servicio.nombre } }
